...
int main()
{
    ...
    // my_sql_real_connect(conn, IP_ADRESS, ID, PASSWORD, DB, PORT, NULL, 0)
    conn_result = mysql_real_connect(conn, "127.0.0.1", "root", "dylee", "world", 3306, NULL, 0);
    ...
    else
    {
        ...
        sprintf_s(query, 1024, "SELECT * FROM city");
